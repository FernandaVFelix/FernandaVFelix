...
export const Card = () => {
  return (
    <Link href="/cursos/vsjvsdjmji" className="hover:no-underline">
      <article className="flex gap-2 flex-col p-2 rounded sm:hover:bg-primary">
        ...
        <p className="line-clamp-3">
          ...
          no React - • Estilização no React: Aula 00 - Curso de f... ⭐️ Curso
          de React com typescript - • Curso de react: Aula 01 - Começando com
          Re... 👑 React, Material UI 5 e Typescript - • React, Material UI 5 e
          ...
          https://amzn.to/4jCan93 Conteúdo: 0:00 | Introdução 0:27 |
